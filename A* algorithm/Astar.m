...
function AStar(startX, startY, targetX, targetY, whichList, figHandle, objMap, delayOption)
    ...
    % CREATE A ROBOT %
    %%%%%%%%%%%%%%%%%%
    xvertices = [-SensorLen,SensorLen,SensorLen,-SensorLen];
    yvertices = [-SensorLen,-SensorLen,SensorLen,SensorLen];
    sensor = patch(xvertices,yvertices,[.9,.9,.9]);
    xvertices = [-RobotLen,RobotLen,RobotLen,-RobotLen];
    yvertices = [-RobotLen,-RobotLen,RobotLen,RobotLen];
